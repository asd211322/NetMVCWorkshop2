...
namespace Net_MVC_Workshop2.Models
{
    public class BookServices
    {
        ...
        public List<Models.BookKeeper> GetBookKeeper(Models.BookKeeper BookKeeper)        //借閱人下拉式
        {
        ...
        public List<Models.BookClass> GetBookClass(Models.BookClass BookClass)        //圖書類別下拉式
        {
            DataTable dt = new DataTable();
            string sql = @"Select  *
                           From [dbo].[BOOK_CLASS] ";
        ...
        public List<Models.BookStatus> GetBookStatus(Models.BookStatus BookStatus)        //借閱狀態下拉式
        {
            DataTable dt = new DataTable();
            string sql = @"Select  *
                           From [dbo].[BOOK_CODE] ";
        ...
        public List<Models.BookSearchArg> GetBookByCondtioin(Models.BookSearchArg Book)        //查詢
        {
        ...
        public int InsertBook(Models.BookSearchArg Book)        //新增
        {
        ...
        public List<Models.BookSearchArg> GetBookUpdateByCondtioin(string BookId)        //修改(抓取資料)
        {
        ...
        public void DeleteBookById(string BookId)        //刪除
        {
            try
            {
        ...
        public void UpdateBookById(Models.BookSearchArg Book)        //修改
        {
            try
            {
        ...
        private List<Models.BookSearchArg> MapBookDataToList(DataTable BookData)        //查詢
        {
        ...
        private List<Models.BookClass> MapBookClassDataToList(DataTable BookClass)        //圖書類別
        {
        ...
        private List<Models.BookKeeper> MapBookKeeperDataToList(DataTable BookKeeper)        //借閱人
        {
        ...
        private List<Models.BookStatus> MapBookStatusDataToList(DataTable BookStatus)        //借閱狀態
        {
        ...
        private List<Models.BookSearchArg> MapBookDataUpdateToList(DataTable BookData)        //修改抓取資料
        {
